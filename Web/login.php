...
<head>
    ...
    <title>تسجيل الدخول - نظام الديون</title>
...
<body class="bg-slate-50 dark:bg-slate-950 flex items-center justify-center min-h-screen p-6">
    <div class="w-full max-w-md bg-white dark:bg-slate-900 rounded-3xl shadow-xl p-10 border border-slate-100 dark:border-slate-800">
        <div class="text-center mb-10">
            ...
            <h1 class="text-3xl font-black text-slate-900 dark:text-white">تسجيل الدخول</h1>
            <p class="text-slate-500 mt-2">مرحباً بك مجدداً في نظام إدارة الديون</p>
        </div>
        ...
        <?php if(isset($_GET['msg'])): ?>
            <div class="bg-emerald-50 text-emerald-600 p-4 rounded-xl mb-6 text-sm font-bold text-center">
                تم إنشاء الحساب بنجاح، يمكنك الآن الدخول.
            </div>
        <?php endif; ?>
        ...
        <form action="allcase.php" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input name="email" required type="email" class="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-2xl py-4 px-6 focus:ring-2 focus:ring-teal-600 outline-none" placeholder="admin@example.com">
            </div>
            <div>
        ...
        <div class="mt-8 text-center">
            <p class="text-slate-500 text-sm">ليس لديك حساب؟ <a href="register.php" class="text-teal-600 font-bold hover:underline">أنشئ حساباً جديداً</a></p>
        </div>
    </div>
